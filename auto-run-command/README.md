...
"auto-run-command.rules": [
  {
    ...
    "command": "git.sync",
    "message": "Git repository detected, syncing..."
  }
]
```
...
|   commandRunSuccess     | Will run if the specified shell command executes successfully (exit code 0)                  | shell command                        | `commandRunSuccess: git rev-parse HEAD`  |
